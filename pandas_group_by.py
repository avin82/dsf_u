...
engagement_df = pd.DataFrame({
    'account_key': ['1200', '1200', '1200', '1200', '1200',
                    ...
                    '1175', '1175', '1175', '1175'],
    'utc_date': ['2015-03-04', '2015-03-5', '2015-03-06', '2015-03-07',
...
print(engagement_df.groupby('account_key').sum())
print(engagement_df.groupby('account_key').sum()['total_minutes_visited'])
print(engagement_df.groupby('account_key').sum()['total_minutes_visited'].mean())
